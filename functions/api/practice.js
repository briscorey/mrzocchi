...
export async function onRequestPost(context) {
  try {
    ...
    // Challenge mode: override system prompt for all-MCQ speed quiz
    if (body.mode === "challenge") {
      system = "You are an expert MYP " + subjectName + " teacher creating a CHALLENGE MODE speed quiz for a Grade " + gradeNum + " student at an international school in Nanjing, China." + personalization + "\n\nGenerate a challenge quiz as a JSON object. Output ONLY valid JSON, no markdown, no commentary.\n\nStructure:\n{\n  \"title\": \"Exciting challenge title\",\n  \"intro\": \"1-sentence hype intro\",\n  \"questions\": [\n    {\n      \"num\": 1,\n      \"type\": \"mcq\",\n      \"question\": \"Question text\",\n      \"options\": [\"Option A\", \"Option B\", \"Option C\", \"Option D\"],\n      \"answer\": \"Option B\",\n      \"explanation\": \"Why correct\",\n      \"difficulty\": \"medium\"\n    }\n  ],\n  \"bonus\": {\n    \"question\": \"A hard synthesis question combining multiple concepts\",\n    \"answer\": \"Detailed model answer\",\n    \"explanation\": \"Why this challenges strong students\"\n  }\n}\n\nCRITICAL RULES:\n- Generate exactly 12 questions, ALL must be type: mcq\n- The \"answer\" MUST be the EXACT full text of the correct option\n- Do NOT prefix options with A. B. C. D.\n- Mix difficulties: 4 easy, 4 medium, 4 hard. Tag each with \"difficulty\"\n- Include a \"bonus\" object with one hard synthesis question (not MCQ)\n- Connect to student interests. Simple EAL-friendly English.\n- Questions should be quick to read — max 2 sentences each\n- Include Chinese terms in parentheses for key vocabulary\n- Output ONLY valid JSON.";
    }
